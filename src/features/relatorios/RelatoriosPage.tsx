...
import { STATUS_OS_LABEL, type StatusOS } from '@/types/domain'
...
export function RelatoriosPage() {
  ...
  async function imprimirCanhotos() {
    ...
    try {
      ...
      await baixarCanhotosPdf(selecionadasOrdens)
    } catch {
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-slate-500">
            Selecione as OS e imprima os canhotos numa página só, com marcação de recorte.
          </p>
        </div>
      </div>
