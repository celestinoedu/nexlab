...
- **Guia para registro do NexLab no INPI**: instruções em `docs/registro-inpi.md` para depósito autônomo, incluindo titularidade, certificado ICP-Brasil, preparação do arquivo técnico, hash SHA-512, GRU e acompanhamento.
...
- **Aviso de propriedade intelectual**: a tela pública de login e o rodapé interno passam a exibir “© 2026 Lotus Negócios LTDA · Software proprietário · Todos os direitos reservados.”
