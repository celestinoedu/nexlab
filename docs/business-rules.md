...
**O primeiro administrador conclui a configuração inicial antes de operar.** Depois de criar a senha, ele confirma nome do laboratório, nome do responsável, telefone e e-mail; documento e endereço são opcionais. Enquanto `empresas.onboarding_concluido = false`, as telas internas redirecionam para essa etapa. Os dados pessoais podem ser revistos em “Meu perfil”, mas a própria pessoa só altera o nome; nível de acesso e vínculo com a empresa continuam protegidos.
