...
**Atualização 2026-09-15 — relatório de parceiros:** o hub de Relatórios ganhou emissão por parceiro e por período (personalizado de até 30 dias, mensal, semestral ou anual) ou por múltiplos serviços selecionados. O extrato de um parceiro também oferece acesso direto ao relatório por serviços, cujo PDF lista e soma somente os itens escolhidos.
